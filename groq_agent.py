...
class GroqAgent:
    def __init__(self, api_key: str, model: str):
        self.api_key = "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"
        self.model = model
    ...
    def create_prompt(self, insights: Dict[str, Any], question: str = "") -> str:
        """Create a prompt for the Groq model based on classroom insights"""
        base_prompt = (
    ...
    def get_analysis(self, insights: Dict[str, Any], question: str = "") -> str:
        """Get AI analysis from Groq based on classroom insights"""
    ...
    def create_timeline_prompt(self, timeline_analysis: Dict[str, Any], question: str = "") -> str:
        """Create a prompt for trend analysis over time"""
        base = (
    ...
    def get_timeline_analysis(self, timeline_analysis: Dict[str, Any], question: str = "") -> str:
        """Get AI analysis from Groq based on classroom timeline data"""
